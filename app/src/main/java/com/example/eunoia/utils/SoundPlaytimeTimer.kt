...
class SoundPlaytimeTimer(listener: OnSoundPlaytimeTimerTickListener) {
    interface OnSoundPlaytimeTimerTickListener{
        fun onSoundPlaytimeTimerTick(
    ...
    init{
        runnable = Runnable {
            ...
            listener.onSoundPlaytimeTimerTick(format(), duration)
            //}
        }
    }
