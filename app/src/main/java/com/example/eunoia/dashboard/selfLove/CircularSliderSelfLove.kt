...
fun CircularSliderSelfLove(
    ...
    LaunchedEffect(key1 = selfLoveAngle.value){
        var a = selfLoveAngle.value
                ...
                when (it.action) {
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        if (d >= radius - touchStroke / 2f && d <= radius + touchStroke / 2f) {
                            down = true
                            selfLoveClicked.value = true
                            selfLoveAngle.value = a + 0
                        } else {
                            down = false
                        }
                    }
                    MotionEvent.ACTION_MOVE -> {
                        if (down) {
                            selfLoveClicked.value = true
                            selfLoveAngle.value = angle(center, offset)
                        }
                    }
