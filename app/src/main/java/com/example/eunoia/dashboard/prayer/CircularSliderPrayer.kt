...
fun CircularSliderPrayer(
    ...
    LaunchedEffect(key1 = prayerAngle.value){
        var a = prayerAngle.value
                ...
                when (it.action) {
                    MotionEvent.ACTION_DOWN -> {
                        ...
                        if (d >= radius - touchStroke / 2f && d <= radius + touchStroke / 2f) {
                            down = true
                            prayerClicked.value = true
                            prayerAngle.value = a + 0
                        } else {
                            down = false
                        }
                    }
                    MotionEvent.ACTION_MOVE -> {
                        if (down) {
                            prayerClicked.value = true
                            prayerAngle.value = angle(center, offset)
                        }
                    }
